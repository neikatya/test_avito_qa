...
### BUG-10 GET /api/1/statistic/{id} возвращает статистику после удаления объявления
...
### BUG-6 Неконсистентный формат ответа GET /api/1/item/{id}
...
### BUG-7 Отсутствие валидации диапазона sellerID
...
### BUG-8 GET /api/1/{sellerID}/item не различает “продавец не найден” и “нет объявлений”
...
### BUG-9 Несогласованный формат ошибок между эндпоинтами
